...
// *************************** 例程测试说明 ***************************
// 1.核心板烧录完成本例程 将核心板插在主板上 插到底 摄像头接在主板的摄像头接口 注意线序 蓝牙CH9141模块插入主板无线模块接口
// 
// 2.主板上电 或者核心板链接完毕后上电
// 
// 3.电脑上使用摄像头的传感器调试助手 串口波特率为 zf_device_bluetooth_ch9141.h 文件中 BLUETOOTH_CH9141_BUAD_RATE 宏定义 默认 115200，核心板按下复位按键
// 
...
int main (void)
{
    ...
    while(1)
    {
        ...
        {
            bluetooth_ch9141_send_image((const uint8 *)ov7725_image_binary, OV7725_IMAGE_SIZE);
