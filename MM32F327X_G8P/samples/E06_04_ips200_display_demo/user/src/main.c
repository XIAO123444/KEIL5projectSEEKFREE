...
int main (void)
{
    ...
    while(1)
    {
        ...
        ips200_show_string(  0,  16 * display_index   ,   "SEEKFREE");          // 显示字符串
        ips200_show_chinese(80,  16 * display_index ++,   16, (const uint8 *)chinese_test, 4, RGB565_BLUE); // 显示汉字

        // 显示的 flaot 数据 最多显示 8bit 位整数 最多显示 6bit 位小数
        ips200_show_float(  0,  16 * display_index   ,   -13.141592,     1, 6); // 显示 float 数据 1bit 整数 6bit 小数 应当显示 -3.141592 总共会有 9 个字符的显示占位
        ips200_show_float( 80,  16 * display_index ++,   13.141592,      8, 4); // 显示 float 数据 8bit 整数 4bit 小数 应当显示 13.1415 总共会有 14 个字符的显示占位 后面会有 5 个字符的空白占位

        ips200_show_int(    0,  16 * display_index   ,   -127,           2);    // 显示 int8 数据
        ips200_show_uint(  80,  16 * display_index ++,   255,            4);    // 显示 uint8 数据

        ips200_show_int(    0,  16 * display_index   ,  -32768,          4);    // 显示 int16 数据
        ips200_show_uint(  80,  16 * display_index ++,  65535,           6);    // 显示 uint16 数据

        ips200_show_int(    0,  16 * display_index   ,  -2147483648,     8);    // 显示 int32 数据 8bit 整数 应当显示 -47483648
        ips200_show_uint(  80,  16 * display_index ++,  4294967295,      8);    // 显示 uint32 数据 10bit 整数 应当显示 4294967295
