...
// 2.主板上电 或者核心板链接完毕后上电
// 
// 3.电脑上使用摄像头的传感器调试助手打开对应的串口 串口波特率为 zf_device_wireless_uart.h 文件中 WIRELESS_UART_BUAD_RATE 宏定义 默认 115200，核心板按下复位按键
// 
// 4.调试助手选择灰度图像 分辨率填写宽188 高120 勾选开始采集
// 
// 5.上位机将会显示图像
// 
...
int main (void)
{
    ...
    while(1)
    {
        ...
        {
            wireless_uart_send_image((const uint8 *)mt9v03x_image, MT9V03X_IMAGE_SIZE);
