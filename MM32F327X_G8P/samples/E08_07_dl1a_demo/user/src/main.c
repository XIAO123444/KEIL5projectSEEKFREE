...
// 接入 DL1A 模块
//      模块管脚            单片机管脚
//      SCL                 查看 zf_device_dl1a.h 中 DL1A_SCL_PIN  宏定义 默认 B1
//      SDA                 查看 zf_device_dl1a.h 中 DL1A_SDA_PIN  宏定义 默认 B2
//      XS                  查看 zf_device_dl1a.h 中 DL1A_XS_PIN  宏定义 默认 B3
//      VCC                 5V 电源
//      GND                 电源地
...
// 1.核心板烧录完成本例程
// 
// 2.在断电情况下，单独使用核心板与调试下载器或者 USB-TTL 模块连接，并连接好 DL1A 模块
...
int main (void)
{
    ...
    while(1)
    {
        ...
        if(pit_ms_flag)
        {
            ...
            printf("\r\nDL1A refresh freq: %5d", dl1a_refresh_freq);
