...
int main (void)
{
    ...
    while(1)
    {
        ...
        if(mt9v03x_finish_flag)
        {
            ...
            // 灰度图像显示 想要修改显示范围就修改本函数后两个参数 分别是显示宽度和高度
            // 灰度图像显示 想要修改显示范围就修改本函数后两个参数 分别是显示宽度和高度
            ips114_displayimage03x((const uint8 *)mt9v03x_image, 240, 135);
            // 这是 ips114_displayimage03x 调用的真实函数 参数意义在其函数头有详细注释
//            ips114_show_gray_image(0, 0, (const uint8 *)mt9v03x_image, MT9V03X_W, MT9V03X_H, 240, 135, 0);
#else
            // 二值化图像显示 参数意义在其函数头有详细注释
            // 二值化图像显示 参数意义在其函数头有详细注释
            // 二值化图像显示 参数意义在其函数头有详细注释
            ips114_show_gray_image(0, 0, (const uint8 *)mt9v03x_image, MT9V03X_W, MT9V03X_H, 240, 135, BINARIZATION_THRESHOLD);
#endif
