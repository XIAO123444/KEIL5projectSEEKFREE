...
// 
// 2.1.14寸IPS模块插入主板屏幕接口 并连接好红孩儿 CCD 模块 在断电情况下完成连接
// 
...
int main (void)
{
    ...
    // 此处编写用户代码 例如外设初始化代码等
    ips114_init();
    ips114_show_string(0, 0, "tsl1401 init.");
    tsl1401_init();
    ips114_show_string(0, 1, "init success.");
    ips114_full(RGB565_66CCFF);
    // 此处编写用户代码 例如外设初始化代码等
    ...
    while(1)
    {
        ...
        {
            ips114_show_wave(0,  0, (const uint16 *)tsl1401_data[0], 128, 255, 128, 65);
            ips114_show_wave(0, 65, (const uint16 *)tsl1401_data[1], 128, 255, 128, 65);
